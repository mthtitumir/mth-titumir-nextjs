...
const AddProjectForm: React.FC = () => {
  ...
  const onSubmit = async (data: ProjectFormInputs) => {
    const processedData = {
        ...data,
        contributions: data.contributions.split(',').map(contribution => contribution.trim()),
        technologies_used: data.technologies_used.split(',').map(tech => tech.trim()),
      };
console.log(processedData);
    ...
    //     },
    //   });
    //   router.push('/projects'); // Redirect to the projects page after successful submission
    // } catch (error) {
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mb-4">
          ...
          {errors.contributions && (
            <p className="text-red-500 text-sm">{errors.contributions.message}</p>
          )}
        </div>
        ...
        <div className="mb-4">
          <label htmlFor="technologies_used" className="block text-md font-medium">
            Technologies Used
          </label>
          <input
          ...
          {errors.technologies_used && (
            <p className="text-red-500 text-sm">{errors.technologies_used.message}</p>
          )}
        </div>
        ...
        <div className="mb-4">
          ...
          {errors.github_client && (
            <p className="text-red-500 text-sm">{errors.github_client.message}</p>
          )}
        </div>
        ...
        <div className="mb-4">
          ...
          {errors.github_server && (
            <p className="text-red-500 text-sm">{errors.github_server.message}</p>
          )}
        </div>
